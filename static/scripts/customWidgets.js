...
class normalityWidget extends HTMLElement {
    ...
    render(){
        ...
        template +=  "<div class='row '> <div class='col-2 mt-3 normalityDrop' ondrop='columnDropNormality(event)' ondragover='allowDrop(event)'><p class='border border-dark dropPlace'> Drag column </p></div>";
...
class ttestWidget extends HTMLElement {
    ...
    render(){
    	...
    	template +=  "<div class='row '> <div class='col-2 mt-3 ttestDrops'> <div class='ttestDrop' ondrop='columnDropTTest(event)' ondragover='allowDrop(event)'><p class='border border-dark dropPlace'> Drag column </p></div>"
        template += "<div class='ttestDrop' ondrop='columnDropTTest(event)' ondragover='allowDrop(event)'><p class='border border-dark dropPlace'> Drag column </p></div>";
        ...
        template+= "<div class='row '> <button class='ms-3 col-2 calculateTTest' onclick='ttestCalculation(this)'>Calculate</button>"
        template += "<table class='col-5 offset-2 ttestTable'><tr><th>PValue</th><th>Test Statistic</th></tr>"
